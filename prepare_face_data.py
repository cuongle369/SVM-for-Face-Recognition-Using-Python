...
def detect_and_crop_faces(image_path, output_dir, person_name, min_face_size=(50, 50)):
    """
    ...
    for (x, y, w, h) in faces:
        ...
        face_path = os.path.join(output_dir, f"{person_name}_{face_count:03d}.jpg")
...
def process_person(person_name, video_dir, output_base_dir, interval=5):
    """
    ...
    for frame_file in frame_files:
        ...
        faces_detected = detect_and_crop_faces(frame_path, person_dir, person_name)
